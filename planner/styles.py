...
def parse_font_string(font_str, default_family='Helvetica', default_style='', default_size=12): # Changed default to Helvetica
...
# --- Main Font Styles ---
# Defaults changed to 'Helvetica' to avoid substitution warnings if Arial is not available/added.
# The config.yaml can still specify "Arial", but FPDF might substitute it if not properly set up with add_font.
FONT_TITLE = parse_font_string(config.get('font_title'), default_family='Helvetica', default_style='B', default_size=16)
FONT_BODY  = parse_font_string(config.get('font_body'), default_family='Helvetica', default_style='', default_size=12)
...
FONT_EXAMEN_STEP_TITLE = parse_font_string(config.get('font_examen_step_title'), default_family='Helvetica', default_style='B', default_size=12)
FONT_EXAMEN_PROMPT = parse_font_string(config.get('font_examen_prompt'), default_family='Helvetica', default_style='I', default_size=10)